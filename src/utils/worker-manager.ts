        ...
        for (const draw of draws) {
            if(draw != undefined){
                ...
                case DrawType.FILL_CUSTOM_QUAD:
                    ...
                    draw.glid = this.gl.fillCustomQuad(options.x1, options.y1, options.x2, options.y2, options.x3, options.y3, options.x4, options.y4, options.fillColor);
                    break;
                case DrawType.DRAW_CUSTOM_QUAD:
                    options = draw.options as CustomQuadOptions;

                    draw.glid = this.gl.drawCustomQuad(options.x1, options.y1, options.x2, options.y2, options.x3, options.y3, options.x4, options.y4, options.color);
                    break;
                case DrawType.FILL_LINED_CUSTOM_QUAD:
                    options = draw.options as CustomQuadOptions;

                    draw.glid = this.gl.fillLinedCustomQuad(options.x1, options.y1, options.x2, options.y2, options.x3, options.y3, options.x4, options.y4, options.fillColor, options.lineColor);
                    break;
